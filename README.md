...
2.	In ``Main.java``, comment out lines 25 and 34 – doing so will make lines 26-33 available to be run. Press run/compile
...
1.	In ``subjects.txt``, list the subject you would like to run (e.g., yumpu)
2.	In ``Main.java``, comment out the LOC that were utilized during the KFG construction and/or the C-Tree construction, if applicable
3.	In ``Main.java``, uncomment line 37 and press run/compile.
